...
axios.interceptors.request.use(config => {
  ...
  //   localStorage.setItem('token', 'c9c19729-7276-48a0-a04b-7c6afa55810b')
  // }
  // loading
  Toast.loading({
...
export function post(url, data) {
  return new Promise((resolve, reject) => {
    // axios.post(url + '?token=adef859f-5029-4d92-a2f4-8d171069db5f', qs.stringify(data)).then(res => {
    axios.post(url + '?token=' + localStorage.getItem('token'), qs.stringify(data))
      .then(res => {
        Toast.clear();
        if (res.data.code == -1) {
          Toast({
